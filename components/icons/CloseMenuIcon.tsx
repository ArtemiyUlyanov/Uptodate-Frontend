...
export type CloseMenuIconProps = React.SVGAttributes<SVGSVGElement>

export const CloseMenuIcon: React.FC<CloseMenuIconProps> = ({ ...props }) => {
  return (
    <svg 
        width="16" 
        height="16" 
