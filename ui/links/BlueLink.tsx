...
const BlueLink: React.FC<BlueLinkProps> = ({
    ...
    return (
        <Link
            className={clsx(
                'relative font-interTight text-roseText whitespace-nowrap w-auto all-unset flex flex-row gap-1 hover:gap-3',
                'transition-all duration-200',
                underliningActived && "before:content-[''] before:absolute before:h-[1px] before:bg-[#ff0000] before:-bottom-1 before:bg-roseColor",
